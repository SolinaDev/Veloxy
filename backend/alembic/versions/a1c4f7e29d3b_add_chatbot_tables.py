...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('treinos_realizados', sa.Integer(), nullable=False),
        sa.Column('calorias_total', sa.Float(), nullable=False),
        sa.Column('melhor_ritmo', sa.Float(), nullable=True),
        sa.Column('maior_distancia', sa.Float(), nullable=False),
